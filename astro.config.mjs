  ...
  prefetch: {
   ...
   env: {
    schema: {
      ...
      CLOUDFLARE_ACCESS_KEY_ID: envField.string({ context: "server", access: "public" }),
      CLOUDFLARE_SECRET_ACCESS_KEY: envField.string({ context: "server", access: "public" }),
      ...
      SALT: envField.string({ context: "client", access: "public" }),
    },
  },
  vite: {
    ssr: {
