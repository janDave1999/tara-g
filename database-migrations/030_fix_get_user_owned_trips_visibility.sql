-- =====================================================
-- 030: Fix get_user_owned_trips — add visibility column
-- =====================================================
-- The previous version of this function (011) did not
-- include the visibility field from trip_visibility.
-- This re-creates the function with the visibility
-- column so TripCard can show and toggle it correctly.
-- =====================================================
