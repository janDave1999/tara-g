-- =====================================================
-- 032: Fix get_discover_trips — explicit type casts
-- =====================================================
-- 031 declared max_pax, current_participants, and
-- estimated_budget as INTEGER in RETURNS TABLE, but
-- the underlying columns are SMALLINT/SMALLINT/INTEGER.
-- PostgreSQL 42804 error: type mismatch at column 13.
-- Fix: add ::INTEGER casts in both SELECT paths.
-- =====================================================
...
BEGIN
    ...
    IF v_has_preferences AND (v_budget_range IS NOT NULL OR v_travel_styles IS NOT NULL OR v_pace_pref IS NOT NULL) THEN
        ...
        SELECT
            ...
            u.avatar_url::TEXT         AS owner_avatar,
            t.slug::TEXT,
