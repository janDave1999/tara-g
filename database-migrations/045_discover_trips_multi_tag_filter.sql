-- =====================================================
-- 045: Update get_discover_trips — multi-select tags (TEXT[])
-- =====================================================
-- Changes p_travel_style from TEXT to TEXT[] so the
-- caller can pass multiple tags at once.
--
-- Filter logic changes:
--   @> (contains-all)  →  && (overlaps / any-match)
-- Trips matching ANY of the selected tags are returned.
-- =====================================================
...
SELECT 'Updated get_discover_trips: p_travel_style is now TEXT[], uses && overlap for multi-select tags' AS status;
